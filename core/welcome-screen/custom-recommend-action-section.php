			...
			<div class="recomended-actions_container" id="plugin-filter">
				...
				<# if( data.required_actions.length == 0 ){ #>
					<p class="succes">
						...
						<# } #>
						<# if( data.wp_review ){ #>
							<a href="https://wordpress.org/support/theme/{{ data.theme_slug }}/reviews/#new-post" class="button button-primary transcend-wordpress"><span class="dashicons dashicons-wordpress"></span>Review this theme on w.org</a>
						<# } #>
					</p>
				<# }else{ #>
					<p class="succes hide">
